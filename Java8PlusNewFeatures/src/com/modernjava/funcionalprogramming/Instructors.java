...
public class Instructors {
    ...
    public static List<Instructor> getAll() {
        ...
        Instructor instructor5 = new Instructor("Syed", 15, "Principal Engineer", "M", false,
                Arrays.asList("Java Programming", "Java Multi-Threaded Programming", "React Native"));

        List<Instructor> instructors = Arrays.asList(instructor1, instructor2, instructor3, instructor4, instructor5);
